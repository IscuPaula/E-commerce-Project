...
(<?=sizeof($_SESSION["shopping_cart"])?>) </li> </a>
            ...
            <form action="/CC-Store/products">
                <select name="filtru" id="filtru">
                    <option value="" disabled selected>Filtreaza</option>
                    <option value="pretCresc">Pret Crescator</option>
                    <option value="pretDescr">Pret Descrescator</option>
                </select>
                <input type="submit" value="Filtreaza">
            </form>
            <form action="/CC-Store/products">
                <input type="text" name="filtreazaNume" id="filtreazaNume">
                <input type="submit" value="Cauta dupa nume">
            </form>
            <div class="card-group">
                <?php foreach($products as $product){?>
                    <div class="card" style="width:14rem">
                        ...
                        <br>
                        <h7 class="card-text">Added by: <?=$product->added_by_user?></h7> 
